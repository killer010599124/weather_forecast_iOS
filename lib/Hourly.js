    ...
    return (
        <ScrollView style={{...styles.container, paddingTop : insets.top}}>
            ...
            <View style={styles.currentWeatherCard}>
                ...
                <Text>Today : {todayData != undefined ? changeDateFormat_7(todayData.datetime) : ""} : {currentCondition != undefined ? currentCondition.datetime : ""}</Text>
                ...
                <Text style={{ alignSelf: 'center', color: 'black' }}>{todayData != undefined ? todayData.description : ""}</Text>
            </View>

            <View style={styles.nextFifteenDaysCard}>
                <Text style={styles.sectionTitle}>Days Forecast</Text>
                {hourlyData != undefined ? hourlyData.map((forecast, index) => (
                    <TouchableOpacity
                        key={index}
                            ...
                            <View style={{ justifyContent: 'space-evenly' }}>
                                ...
                                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                                    ...
                                    <View style={{ width: '33%' }}>
                                        ...
                                        <Text style={{ color: 'black', textAlign: 'center', fontSize: 14 }}>{convertWindUnit(forecast.windspeed)}</Text>
                                    </View>
